...
-- Tiempo de generación: 04-10-2021 a las 19:35:35
...
INSERT INTO `estadotoken` (`Id`, `Nombre`) VALUES
(1, 'Enviado'),
(2, 'En Atencion'),
(3, 'No Procede'),
(4, 'Exitoso/Finalizado');
...
INSERT INTO `recursos` (`Id`, `Nombre`, `Marca`, `Modelo`, `NumSerie`, `IdTipoRecurso`, `DireccionIP`, `DireccionMAC`, `Cargador`, `CodActivo`, `IdAreaAsignada`) VALUES
('R00001', 'DESKTOP-SD6RO5M', 'HP', '14-ck0013la', '5CG8182FC6', 1, '172.19.8.151', '80:C5:F2:A2:57:C3', 1, 'FS0-ST-EI-0049', 'AR0001'),
('R00002', 'OFFICE 365', 'NO', 'NO', 'NO', 1, NULL, NULL, 0, 'FSO-51-MO-003', 'AR0001');
