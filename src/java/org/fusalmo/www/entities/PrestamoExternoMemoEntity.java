 ...
 */
@Entity
@Table(name = "prestamoexternomemo")
@NamedQueries({
    @NamedQuery(name = "PrestamoExternoMemoEntity.findAll", query = "SELECT p FROM PrestamoExternoMemoEntity p")
    , @NamedQuery(name = "PrestamoExternoMemoEntity.findById", query = "SELECT p FROM PrestamoExternoMemoEntity p WHERE p.id = :id")
    , @NamedQuery(name = "PrestamoExternoMemoEntity.findByInicioPrestamo", query = "SELECT p FROM PrestamoExternoMemoEntity p WHERE p.inicioPrestamo = :inicioPrestamo")
    , @NamedQuery(name = "PrestamoExternoMemoEntity.findByFinPrestamo", query = "SELECT p FROM PrestamoExternoMemoEntity p WHERE p.finPrestamo = :finPrestamo")
    , @NamedQuery(name = "PrestamoExternoMemoEntity.findByCantidadRecursos", query = "SELECT p FROM PrestamoExternoMemoEntity p WHERE p.cantidadRecursos = :cantidadRecursos")})
public class PrestamoExternoMemoEntity implements Serializable {
    ...
    @OneToMany(mappedBy = "idPrestamoExternoMemo")
    private List<MemosEntity> memosEntityList;

    public PrestamoExternoMemoEntity() {
    }

    public PrestamoExternoMemoEntity(String id) {
        this.id = id;
    }

    public PrestamoExternoMemoEntity(String id, Date inicioPrestamo, Date finPrestamo, int cantidadRecursos) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PrestamoExternoMemoEntity)) {
            return false;
        }
        PrestamoExternoMemoEntity other = (PrestamoExternoMemoEntity) object;
    ...
    public String toString() {
        return "org.fusalmo.www.entities.PrestamoExternoMemoEntity[ id=" + id + " ]";
    }
